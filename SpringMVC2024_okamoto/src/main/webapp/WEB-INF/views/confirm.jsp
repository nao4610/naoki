...
<body>
	<h1>M001 社員所属登録</h1>
	<form:form action="/question/completion" modelAttribute="userForm">
		<table cellpadding="3">
			<tr>
				<th>社員名(氏名)</th>
			...
			<tr>
				...
				<form:radiobutton path="gender" value="0" required="true"/> 男性 
				<form:radiobutton path="gender" value="1" required="true"/> 女性</td>
			</tr>
			<tr>
				<th>生年月日</th>
			...
			<tr>
				<th>配偶者の有無</th>
				<td colspan="3" class="no-border">
				<form:radiobutton path="spouse" value="0" required="true"/> 有 
				<form:radiobutton path="spouse" value="1" required="true"/> 無</td>
			</tr>
			<tr>
				<th>扶養の有無</th>
				<td colspan="3" class="no-border">
				<form:radiobutton path="dependents" value="0" required="true"/> 有 
				<form:radiobutton path="dependents" value="1" required="true"/> 無</td>
			</tr>
			<tr>
				<th>VISAの有無</th>
				<td colspan="3" class="no-border">
				<form:radiobutton path="visa" value="0" required="true"/> 有 
				<form:radiobutton path="visa" value="1" required="true"/> 無</td>
				<td>(期限)</td>
